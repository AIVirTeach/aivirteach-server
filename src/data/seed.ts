...
export const seedCourses: Course[] = [
  { id: "ai-daily-briefing", title: "Build an AI Daily Briefing with n8n", category: "AI Automation", description: "Build a self-hosted workflow that collects, ranks, summarizes, and emails the most important AI and technology news.", level: "Intermediate", durationMinutes: 480, lessonCount: 11, published: true },
